...
grammar_eval_limiter = ToolCallLimitMiddleware(tool_name="evaluate_grammar", run_limit=1, exit_behavior="error")
reading_eval_limiter = ToolCallLimitMiddleware(tool_name="evaluate_reading", run_limit=1, exit_behavior="error")
listening_eval_limiter = ToolCallLimitMiddleware(tool_name="evaluate_listening", run_limit=1, exit_behavior="error")
